...
class Database
{
    ...
    public function __construct()
    {
        ...
        try {
            ...
            /**
             * Wanneer er een error optreed tonen we een gebruiksvriendelijke melding
             */
            echo "Op dit moment kunnen we u niet helpen... probeer het later nog eens";
            // Log error to error log instead of using undefined logger function
    ...
    public function outQuery($sql) {
        return $this->dbHandler->query($sql)->fetchAll(PDO::FETCH_OBJ);
    }
}